...
Reference full template: `/home/negus/dev/prosperity/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/negus/dev/prosperity/.claude/get-shit-done/templates/state.md`.
