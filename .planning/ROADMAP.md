...
- [x] 02-03-PLAN.md — AuthService + AuthController (setup, login, logout, me, status endpoints)
- [x] 02-04-PLAN.md — Backend integration tests (AuthController, AuthService, SecurityConfig, UserDetailsService)
...
Plans:
- [ ] 06-01-data-layer-PLAN.md — Flyway V014/V015 migrations + Envelope @ManyToMany + repositories (consumed CTE, D-01 uniqueness, 12-month history)
...
- [ ] 06-03-test-scaffolds-PLAN.md — Wave 0 RED stubs for EnvelopeService/Controller/AllocationController tests
...
- [ ] 06-05-controllers-PLAN.md — EnvelopeController + EnvelopeAllocationController (REST endpoints, exception -> HTTP status mapping including 409)
...
| 5. Transactions | 2/6 | In Progress|  |
