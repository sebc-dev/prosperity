...
- [ ] 01-02-PLAN.md — Domain model: entities, value objects, enums, repositories, migrations
- [ ] 01-03-PLAN.md — Unit tests: Money, TransactionState, Envelope, ArchUnit
- [ ] 01-04-PLAN.md — Frontend scaffolding: Angular 21 + PrimeNG + Tailwind + ESLint + Prettier
- [ ] 01-05-PLAN.md — Infrastructure: Docker Compose + Caddy + CI pipeline + Lefthook
...
|-------|----------------|--------|-----------|
| 1. Project Foundation | 0/5 | Planning | - |
