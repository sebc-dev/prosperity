...
| [E18](./E18-devx-ci.md) | DevX / CI (optimisation workflows) | CI path-scopée par périmètre (backend/frontend/docs) + agrégateur de *required check* + parallélisme + cache uv/npm/Docker + runbook ; quality gate « Sonar sans serveur » (lint strict, code mort/duplication, mutation) | E01 | in progress (S18.2) |
